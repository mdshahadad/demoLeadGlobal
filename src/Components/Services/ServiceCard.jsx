...
const ServiceCard = () => {
  return (
    <div className="lg:flex justify-center lg:gap-2 gap-4 2xl:mx-0 mx-4 lg:space-y-0 space-y-4">
      <div className="relative cursor-pointer hover-effect">
        <div className="absolute inset-0 bg-black/60 rounded"></div>
        <img
          src={servicesOne}
          alt=""
          className="rounded xl:w-[500px] w-[420px]"
        />
        <div className="absolute xl:top-24 top-6 left-0 text-white p-4">
          <h2 className="xl:text-[70px] text-5xl 2xl:leading-16 xl:leading-13 leading-9 font-extrabold uppercase">
            strategic Branding
          </h2>
          <p className="xl:mt-16 lg:mt-8 mt-10 xl:text-lg font-light">
